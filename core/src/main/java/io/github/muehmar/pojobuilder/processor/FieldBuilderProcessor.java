...
public class FieldBuilderProcessor {
  ...
  public static PList<io.github.muehmar.pojobuilder.generator.model.FieldBuilder> process(
      TypeElement element) {
    ...
    return NonEmptyList.fromIter(singleMethodMethods.concat(classMethods))
        .map(
            methods -> {
              ...
              return new io.github.muehmar.pojobuilder.generator.model.FieldBuilder(
